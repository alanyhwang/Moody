...
public class JsonWriterTest extends JsonTest {
    ...
    void testWriterMoodListAllTag() {
        try {
            ...
            checkMood(2, LocalDate.parse("1992-02-02"), "Not Bad", "Positive Neutral", "playing games", new Color(102, 255, 102), "\u001b[38;5;10m", moods.get(1));
            checkMood(3, LocalDate.parse("1993-03-03"), "OK", "Neutral", "sleeping in bed zzz", new Color(255, 255, 255), "\u001b[0m", moods.get(2));
            checkMood(4, LocalDate.parse("1994-04-04"), "Sad", "Negative Neutral", "Imma go cry now", new Color(255, 102, 102), "\u001b[38;5;9m", moods.get(3));
            checkMood(5, LocalDate.parse("1995-05-05"), "Angry", "Negative", "IM SUPER ANGRY.", new Color(255, 0, 0), "\u001b[38;5;160m", moods.get(4));
