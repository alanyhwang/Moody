...
public class JsonReaderTest extends JsonTest {
    ...
    void testReaderMoodListAllTags() {
        ...
        try {
            ...
            checkMood(3, LocalDate.parse("1992-02-02"), "Not Bad", "Positive Neutral", "playing games", new Color(169, 236, 185), "\u001b[38;5;10m", moods.get(1));
            checkMood(4, LocalDate.parse("1993-03-03"), "OK", "Neutral", "sleeping in bed zzz", new Color(222, 218, 218), "\u001b[0m", moods.get(2));
            checkMood(5, LocalDate.parse("1994-04-04"), "Sad", "Negative Neutral", "Imma go cry now", new Color(245, 185, 185), "\u001b[38;5;9m", moods.get(3));
            checkMood(6, LocalDate.parse("1995-05-05"), "Angry", "Negative", "IM SUPER ANGRY.", new Color(239, 144, 148), "\u001b[38;5;160m", moods.get(4));
